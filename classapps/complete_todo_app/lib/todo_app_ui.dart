...
class _todo_app_ui extends State{
  ...
  List <ToDoModel>todocards=[
          ToDoModel(title: "flutter", description: "dart,widget", date: "15 november 2024",),
          ToDoModel(title: "Springboot", description: "backend technology and hard to understand ", date: "16,November 2024",),
          ToDoModel(title: "web development", description: "html,css,js,mernstack,db", date: "17 November 2024",),
  ];
  ...
  void submit (bool isEdit,[ToDoModel? todoobj]){
     if(titleController.text.trim().isNotEmpty&&dateController.text.trim().isNotEmpty&&descriptionController.text.trim().isNotEmpty){
